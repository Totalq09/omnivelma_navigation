...
#include "facialfeaturescloud_profile.hpp"
...
FacialProfileFeaturesPointCloudPublisher::FacialProfileFeaturesPointCloudPublisher(ros::NodeHandle& rosNode,
    ...
    facePrefix(prefix)
{
    ...
    exact_sync_->registerCallback(bind(&FacialProfileFeaturesPointCloudPublisher::imageCb, this, _1, _2, _3));
}
 ...
 */
template<typename T>
void FacialProfileFeaturesPointCloudPublisher::makeFeatureCloud(const vector<Point> points2d,
...
void FacialProfileFeaturesPointCloudPublisher::imageCb(const sensor_msgs::ImageConstPtr& rgb_msg,
                                                const sensor_msgs::ImageConstPtr& depth_msg,
    ...
    ********************************************************************/
    ...
    else
    {
        ...
        cloud_msg->height = 1;
        cloud_msg->width  = 30; // nb of facial features
