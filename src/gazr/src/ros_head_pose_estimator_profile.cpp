#include "ros_head_pose_estimator_profile.hpp"
...
HeadPoseEstimatorProfile::HeadPoseEstimatorProfile(ros::NodeHandle& rosNode,
                                     const string& prefix,
...
{
    sub = it.subscribeCamera("rgb", 1, &HeadPoseEstimatorProfile::detectFaces, this);
...
void HeadPoseEstimatorProfile::detectFaces(const sensor_msgs::ImageConstPtr& rgb_msg, 
