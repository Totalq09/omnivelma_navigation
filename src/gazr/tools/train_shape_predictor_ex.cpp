...
int main(int argc, char** argv)
{
    try
    {
        ...
        load_image_dataset(images_test, faces_test, faces_directory+"/testing_face_landmarks.xml");
        ...
        // the regularization (making nu smaller) and by using trees withs
        // smaller depths.  
        trainer.set_nu(0.25);
...
)
{
    ...
    //Find the center of mouth
    cnt = 0;
    for (unsigned long i = 19; i <= 24; ++i) 
    {
        r += det.part(i);
        ++cnt;
    }
