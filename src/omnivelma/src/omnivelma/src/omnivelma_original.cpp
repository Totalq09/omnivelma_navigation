...
#define MAP_TF "rotated_omnivelma"
...
public:
	...
	void Load(physics::ModelPtr parent, sdf::ElementPtr sdf)
	{
		...
		//Autor: Piotr Walas
		rosOdom = rosNode->advertise<nav_msgs::Odometry>(topicPrefix + "odom", 1000);
		if(!rosOdom)
		{
			ROS_FATAL_STREAM("Nie udało się stworzyć nadajnika " << topicPrefix << "odom");
		}
